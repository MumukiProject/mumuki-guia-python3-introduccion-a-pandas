¡Las tres operaciones funcionan! 🎊 Pero hay una sutil diferencia: cuando usamos `head` y `tail` con `Series` nos  devuelven otro `Series` con los valores seleccionados.
